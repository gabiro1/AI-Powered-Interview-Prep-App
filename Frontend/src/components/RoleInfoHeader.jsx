  ...
  return (
    <div className='bg-white relative'>
        <div className='container mx-auto px-10 md:px-0'>
            ...
            <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center bg-white overflow-hidden absolute top-0 right-0'>
                ...
                <div className='w-16 h-16 bg-fuchsia-400 blur-[45px] animate-1'/>
            </div>
        </div>
    </div>
  )

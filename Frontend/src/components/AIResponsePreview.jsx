...
const AIResponsePreview = ({content}) => {
  ...
  return (
    <div className='max-w-4xl mx-auto'>
        <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none text-gray-800'>
            <ReactMarkdown
                ...
                components={{
                    code({node, className, children, ...props}){
                        ...
                        return !isInline ? (
                            ...
                            <code className=" px-1 py-0.5bg-gray-100 rounded text-sm" {...props}>
                                { children }
                            </code>
                        )
                    },
...
function CodeBlock({code, language}){
    ...
    return <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50  border border-gray-200'>
        <div className='flex items-center justify-between px-4 py-2 bg-gray-100 border border-gray-200'>
            ...
            >
                ...
                {
                    copied && (
                        <span className='absolute top-8 right-0  bg-black text-white text-xs px-2 py-1  opacity-80 group-hover:opacity-100 transition'> Copied!</span>
                    ) 
                }

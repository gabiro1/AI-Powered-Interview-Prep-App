...
const SummaryCard = ({
  ...
  return (
    <div
    className='bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden  cursor-pointer hover:shadow-xl shadow-gray-100 relative group w-96'
                ...
                <div className='flex-grow'>
                    <div className='flex justify-between items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-sm text-medium text-gray-900'>{topicsToFocus}</p>
                        </div>
                    </div>
                </div>
            </div>
